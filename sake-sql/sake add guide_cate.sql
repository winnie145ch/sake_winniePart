...
CREATE TABLE `guide_cate` (
  `guide_c_id` int(8) NOT NULL,
  `q_cate` varchar(10) NOT NULL,
  `q_cate_name` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `guide_cate` (`guide_c_id`, `q_cate`, `q_cate_name`) VALUES
(1, 'a', '專業指南'),
(2, 'b', '心情指南'),
(3, 'c', '必問問題');
...
(7, 7, 'Emma', '1996-05-03', '0970777000', '台北市大同區承德路七段55號', ''),
(8, 8, 'Frank', '1983-02-04', '0966688890', '台北市士林區德行東路90號', ''),
(9, 9, 'Even', '1988-03-03', '0923323223', '台北市士林區天母西路95巷3號', ''),
(10, 10, 'Huck', '1972-02-28', '0953553434', '台北市士林區中山北路七段77號7樓', ''),
(11, 11, 'Vinence', '1989-10-19', '0988788899', '台北市北投區北投路二段33號', ''),
(12, 12, 'Jolin', '1975-03-15', '0910555666', '台北市士林區東山路385巷3號', ''),
(13, 13, 'Ivy', '1975-05-12', '0932343889', '台北市士林區後街3巷3號', ''),
(14, 14, 'Kevin', '1985-07-28', '0909133132', '台北市士林區中山北路六段77號3樓', ''),
(15, 15, 'Peter', '1992-12-02', '0978777333', '台北市北投區奇岩路266號', '');
...
(1, 1880, 720, '奈良縣', '純米大吟釀', '篠峯', 50, 16, '千代酒造', '雄町', '輕盈甘口偏甜', '冷酒常溫', 0, 0, 5),
(2, 2080, 720, '山形縣', '純米大吟釀', '榮光富士', 50, 17, '冨士酒造', '美山錦', '適中甘口偏酸', '冷酒常溫燗酒', 0, 0, 5),
(3, 1280, 720, '滋賀縣', '純米酒', '喜樂長', 65, 16, '喜多酒造', '吟吹雪 山田錦', '輕盈甘口偏甜', '常溫燗酒', 0, 0, 5),
(4, 1640, 720, '京都府', '純米吟釀', '白木久', 55, 16, '白杉酒造', '越光米', '輕盈甘口偏酸', '冷酒', 0, 1, 5),
(5, 2020, 720, '福井縣', '純米大吟釀', '鳳凰源平', 48, 17, '源平酒造', '山田錦', '適中甘口偏甜', '冷酒', 0, 1, 5),
(6, 1680, 720, '長野縣', '純米大吟釀', '真澄', 40, 15, '宮坂酒造', '山田錦', '適中辛口偏甜', '常溫燗酒', 0, 1, 5),
(7, 2080, 720, '兵庫縣', '純米大吟釀', '真澄', 45, 16, '宮坂酒造', '美山錦', '輕盈甘口偏酸', '燗酒', 0, 1, 5),
(8, 1280, 720, '長野縣', '純米大吟釀', '真澄', 45, 16, '宮坂酒造', '山田錦', '輕盈甘口偏甜', '冷酒', 2, 0, 5),
(9, 1680, 720, '長野縣', '純米吟釀', '真澄', 55, 15, '宮坂酒造', '美山錦 山田錦山惠錦', '適中甘口偏酸', '冷酒常溫', 0, 1, 5),
(10, 2080, 720, '長野縣', '純米酒', '真澄', 70, 15, '宮坂酒造', '美山錦HITOGOKOCHI', '適中甘口偏甜', '冷酒常溫燗酒', 0, 1, 5),
(11, 1780, 720, '長野縣', '純米吟釀', '真澄', 55, 12, '宮坂酒造', '山惠錦HITOGOKOCHI', '輕盈辛口偏酸', '常溫燗酒', 0, 0, 5),
(12, 780, 720, '長野縣', '本釀造', '真澄', 60, 15, '宮坂酒造', '美山錦', '輕盈辛口偏甜', '燗酒', 0, 0, 5),
(13, 2680, 720, '福島縣', '純米大吟釀', '會津譽', 39, 16, '會津譽酒造', '山田錦 五百萬石', '適中辛口偏酸', '冷酒', 1, 0, 5),
(14, 2080, 720, '群馬縣', '純米大吟釀', '水芭蕉', 50, 16, '永井酒造', '山田錦', '適中辛口偏甜', '冷酒常溫', 3, 0, 1),
(15, 1280, 720, '群馬縣', '純米大吟釀', '水芭蕉', 50, 16, '永井酒造', '山田錦', '輕盈甘口偏酸', '冷酒常溫燗酒', 3, 0, 1),
(16, 1680, 720, '福島縣', '純米大吟釀', '會津譽', 40, 16, '會津譽酒造', '山田錦', '輕盈甘口偏甜', '常溫燗酒', 1, 0, 5),
(17, 880, 720, '高知縣', '純米酒', '文佳人', 55, 16, '有澤酒造', '未公開', '適中甘口偏酸', '燗酒', 2, 0, 5),
(18, 3780, 720, '高知縣', '純米吟釀', '文佳人', 50, 17, '有澤酒造', '未公開', '適中甘口偏甜', '冷酒', 2, 0, 5),
(19, 380, 180, '廣島縣', '吟釀', '誠鏡/幻', 58, 16, '中尾釀造', '新千本', '適中辛口偏酸', '常溫燗酒', 0, 0, 5),
(20, 980, 720, '新潟縣', '吟釀', '久保田', 55, 15, '朝日酒造', '五百萬石', '適中辛口偏甜', '燗酒', 0, 0, 5),
(21, 380, 300, '福岡縣', '本釀造', '喜多屋', 70, 14, '喜多屋', '福岡縣產米', '輕盈甘口偏酸', '冷酒', 3, 0, 2),
(22, 1380, 720, '福岡縣', '本釀造', '庭之鶯', 68, 15, '山口酒造', '山田錦 夢一獻', '輕盈甘口偏甜', '冷酒常溫', 0, 0, 5),
(23, 1980, 720, '長野縣', '純米吟釀', '真澄', 55, 15, '宮坂酒造', '美山錦 人心地', '適中甘口偏酸', '冷酒常溫燗酒', 2, 0, 5),
...
(31, 780, 720, '兵庫縣', '大吟釀', '大關', 50, 15, '大関株式會社', '未標示', '適中甘口偏酸', '冷酒', 0, 0, 5),
(32, 480, 720, '愛知縣', '純米酒', '金虎', 60, 15, '金虎酒造', '一般米', '適中甘口偏甜', '冷酒常溫', 0, 0, 5),
(33, 1280, 720, '愛知縣', '純米大吟釀', '金虎', 40, 15, '金虎酒造', '山田錦', '輕盈辛口偏酸', '冷酒常溫燗酒', 1, 0, 5),
(34, 12800, 720, '山形縣', '大吟釀', '十四代', 35, 16, '高木酒造', '山田錦', '輕盈辛口偏甜', '常溫燗酒', 3, 0, 3),
(35, 880, 720, '奈良縣', '純米酒', '鷹長', 70, 15, '油長酒造', '奈良米', '適中辛口偏酸', '燗酒', 0, 0, 5),
(36, 3180, 1800, '福島縣', '本釀造', '十四代', 60, 15, '高木酒造', '美山錦', '適中辛口偏甜', '冷酒', 0, 0, 5),
(37, 880, 720, '奈良縣', '純米酒', '風之森', 70, 15, '油長酒造', '奈良米', '輕盈甘口偏酸', '冷酒常溫', 0, 0, 5),
(38, 1280, 720, '新潟縣', '大吟釀', '越後櫻', 50, 15, '越後櫻酒造', '山田錦', '輕盈甘口偏甜', '冷酒常溫燗酒', 0, 0, 5),
(39, 880, 720, '秋田縣', '純米酒', 'Private Lab', 60, 13, '新政酒造', '小町', '適中甘口偏酸', '常溫燗酒', 0, 0, 5),
(40, 1180, 720, '群馬縣', '吟釀', '龍神', 60, 17, '龍神酒造', '未公開', '適中甘口偏甜', '燗酒', 1, 0, 5),
(41, 780, 750, '三重縣', '純米酒', '作', 65, 15, '清水清三郎商店', '未標示', '輕盈辛口偏酸', '冷酒', 0, 0, 5),
(42, 1380, 720, '新潟縣', '吟釀', '青木酒造', 60, 16, '青木酒造', '越淡麗', '輕盈辛口偏甜', '冷酒常溫', 3, 0, 4),
(43, 780, 750, '三重縣', '純米酒', '作', 65, 15, '清水清三郎商店', '未標示', '適中辛口偏酸', '冷酒常溫燗酒', 0, 0, 5),
(44, 1180, 720, '佐賀縣', '純米大吟釀', '鍋島', 45, 16, '富久千代酒造', '山田錦', '適中辛口偏甜', '常溫燗酒', 0, 0, 5),
(45, 1380, 720, '德島縣', '吟釀', '本家松浦酒造', 58, 19, '本家松浦酒造', '山田錦', '輕盈甘口偏酸', '燗酒', 0, 0, 5),
(46, 780, 720, '山形縣', '純米吟釀', '花邑', 50, 15, 'くどき上手', '山田錦 美山錦', '輕盈甘口偏甜', '冷酒', 0, 0, 5),
(47, 680, 300, '新潟縣', '吟釀', '加茂錦酒造', 60, 15, '加茂錦酒造', '山田錦', '適中甘口偏酸', '冷酒常溫', 0, 0, 5),
(48, 580, 720, '富山縣', '純米吟釀', '滿壽泉', 58, 15, '桝田酒造店', '山田錦', '適中甘口偏甜', '冷酒常溫燗酒', 0, 0, 5),
(49, 2180, 720, '群馬縣', '純米大吟釀', '龍神', 39, 16, '未公開', '山田錦', '輕盈辛口偏酸', '常溫燗酒', 0, 0, 5),
(50, 1380, 720, '長野縣', '吟釀', '大雪溪酒造', 55, 15, '大雪溪酒造', '美山錦', '輕盈辛口偏甜', '燗酒', 0, 0, 5),
(51, 1380, 720, '岐阜縣', '吟釀', '奧飛驒酒造', 60, 14, '奧飛驒酒造', 'ひだほまれ', '適中辛口偏酸', '冷酒', 0, 0, 5),
(52, 780, 720, '青森縣', '純米吟釀', '陸奥八仙', 55, 16, '八戸酒造', '青森縣産米', '適中辛口偏甜', '冷酒常溫', 0, 0, 5),
(53, 1980, 1800, '宮城縣', '本釀造', '墨迺江', 60, 15, '墨廼江酒造', '五百萬石', '輕盈甘口偏酸', '冷酒常溫燗酒', 0, 0, 5),
(54, 880, 720, '山梨縣', '本釀造', '七賢', 70, 16, '七賢酒造', '人心地、朝日の夢', '輕盈甘口偏甜', '常溫燗酒', 0, 0, 5),
(55, 980, 720, '新潟縣', '本釀造', '八海山', 60, 16, '八海山酒造', '五百萬石', '適中甘口偏酸', '燗酒', 3, 0, 4),
...
(59, 1380, 720, '青森縣', '本釀造', '篠峯', 1, 1, '千代酒造', '雄町', '偏酸甘口適中', '冷酒', 2, 1, 5),
(60, 3, 2, '大阪府', '純米吟釀', 'dsad', 2, 4, 'asdasd', 'asdasd', '輕盈偏甜甘口', '燗酒常溫冷酒', 3, 1, 1),
(61, 44, 1, '京都府', '大吟釀', '篠峯', 45, 3, 'qe', 'qwe', '偏酸辛口適中', '冷酒', 2, 0, 5),
(62, 3, 1, '京都府', '純米大吟釀', '篠峯', 4, 5, '千代酒造', 'dsaads', '偏酸辛口輕盈', '冷酒', 3, 1, 1),
(63, 3, 2, '大阪府', '本釀造', '篠峯', 2, 3, 'sadads', 'dasds', '適中甘口偏甜', '燗酒', 1, 0, 5),
(64, 1, 2, '京都府', '純米吟釀', '篠峯', 2, 2, '千代酒造', '測試', '適中辛口偏酸', '燗酒', 2, 1, 5),
(65, 2324, 4, '北海道', '純米吟釀', '324324', 96, 4, '324', '234', '適中甘口偏甜', '常溫', 1, 0, 5),
(66, 4, 3, '大阪府', '大吟釀', 'qweqwe', 2, 3, 'dsfsdf', 'sdfdfs', '辛口輕盈偏甜', '冷酒燗酒', 1, 0, 5),
(67, 3, 3, '大阪府', '純米吟釀', 'sasda', 2, 3, 'sadasd', 'sadsad', '偏甜輕盈辛口', '燗酒', 0, 1, 5),
(68, 3, 3, '大阪府', '純米吟釀', 'sasda', 2, 3, 'sadasd', 'sadsad', '偏甜輕盈辛口', '燗酒', 0, 1, 5),
(69, 3, 3, '大阪府', '純米吟釀', 'sasda', 2, 3, 'sadasd', 'sadsad', '偏甜輕盈辛口', '燗酒', 0, 1, 5),
(70, 3, 3, '大阪府', '純米吟釀', 'csad', 4, 3, 'sadsad', 'saasdasd', '偏甜辛口適中', '燗酒常溫冷酒', 1, 1, 5),
(71, 3, 3, '京都府', '大吟釀', '篠峯', 3, 4, 'as', 'aㄋ', '偏酸辛口適中', '燗酒', 0, 0, 5),
(72, 3, 3, '京都府', '純米大吟釀', 'erre', 3, 3, '千代酒造', '測試', '偏酸辛口適中', '冷酒常溫燗酒', 1, 1, 5);
...
(10, 3, '9.png.png', 'black', '[5,15,20,25,30,35]'),
(11, 3, 'red-4.jpg', 'red', '[5,15,20,25,30,35]'),
(12, 2, 'gold-4.jpg', 'gold', '[5,15,20,25,30,35]'),
(13, 2, '7-s.jpg.jpg', 'indigo', '[1,2,3,4,5,6]');
...
(59, '真澄 山花純米大吟釀', 1, 1, '酒名取自李白的詩「兩人對酌山花開，一杯一杯又一杯」。口味淡雅清麗，有果實般的芳香，令人聯想起初春山峰上盛開的鮮花。海外人氣極高。於2015年International Wine Challenge中獲得銀牌。', '已下架', 59, 'test1.png.png', '2022-01-11 01:22:23', '2022-01-08 21:49:46'),
(60, '真澄 七號純米大吟釀', 2, 2, '用發源於真澄酒藏的七號酵母和長野縣產美山錦米，採用傳統技法山廢釀法釀造而成。是長野縣與真澄酒藏極具代表性的清酒。口感穩重中帶酸，有淡淡的果香，酒體優雅而具層次感。海外人氣度極高。於2015年International Wine Challenge中獲得銀獎。\r\n', '已下架', 60, 'test2.png.png', '2022-01-11 01:22:31', '2022-01-08 21:51:25'),
(61, '真澄 夢殿純米大吟釀', 1, 2, '如浴火鳳凰的蛻變重生，將酒的形象與酒造的精神反映在酒標上，深紫色與金箔細膩的交織而成誕生美麗的鳳凰，感受得到精細的設計工藝。使用全量山田錦精米至48%。香氣為華麗的吟釀香。熟成蘋果般的香氣。收尾俐落，輕快且飽滿的口感的純米大吟釀酒款。推薦的飲用方法是冰溫或是略冰。華麗的香氣組成，在甜味與酸味當中取得平衡的味道。可以確實感受到米的旨味的酒款。香氣與味道會隨著溫度而變化是其旨趣，漂亮且水潤感滿溢的味道使人愛不釋口。選用日本百水「御清水」，口感柔軟滑順是其特點。With Original Phoenix Carton Box\r\n', '已下架', 61, 'test3.png.png', '2022-01-11 01:22:33', '2022-01-08 21:52:12'),
(62, '鳳凰源平 純米大吟釀', 1, 1, '如浴火鳳凰的蛻變重生，將酒的形象與酒造的精神反映在酒標上，深紫色與金箔細膩的交織而成誕生美麗的鳳凰，感受得到精細的設計工藝。使用全量山田錦精米至48%。香氣為華麗的吟釀香。熟成蘋果般的香氣。收尾俐落，輕快且飽滿的口感的純米大吟釀酒款。推薦的飲用方法是冰溫或是略冰。華麗的香氣組成，在甜味與酸味當中取得平衡的味道。可以確實感受到米的旨味的酒款。香氣與味道會隨著溫度而變化是其旨趣，漂亮且水潤感滿溢的味道使人愛不釋口。選用日本百水「御清水」，口感柔軟滑順是其特點。With Original Phoenix Carton Box\r\n', '已下架', 62, 'test4.png.png', '2022-01-11 01:22:38', '2022-01-08 21:53:39'),
(63, '白木久BLACK LABEL Brilliant 純米吟釀', 5, 5, 'BLACK LABEL系列採用黑麴釀造!優雅美麗的甜味和酸味，直覺會以為黑麴釀製出的酒會特別酸，但其實BLACK LABEL系列所強調的風格比起酸度更強調酒米的旨味與香氣的力度，甜味較vibrant更加清爽入口彷彿吃下現摘草莓般的味道，散發出多汁的甜味和酸味，細膩的微發泡感，更讓整體喝起來甜而不膩，非常清爽好入口。\r\n', '已下架', 63, 'test5.png.png', '2022-01-11 01:22:40', '2022-01-08 21:54:33'),
(64, ' ★喜樂長FIGHT！台湾！純米 應援酒', 2, 3, '如同夏季吹過琵琶湖面涼爽的風、表現爽快又舒服的一款酒。微微柑橘類與香草系的香氣撲鼻、飲入口中，輕巧地滲透心脾，能品嘗到些許的甜味與輕快的酸味滑過舌面，尾韻帶有爽快dry感。顺滑清澈的美味隨之而來是，水嫩的酸味伴隨著清涼感，冰飲的消暑伴隨清澈香氣和溫柔的甜味在口中滿溢。\r\n', '已下架', 64, 'test6.png.png', '2022-01-11 01:22:43', '2022-01-08 21:55:59'),
(65, '榮光富士 純米大吟釀 黒狐', 3, 3, '超人氣黑狐入荷 自古以來黑狐與白狐是獲得日月精華與多年修行之後幻化成的妖狐，雖然長得有一點點可怕，其實是帶來吉兆的『瑞獸』，特別是黑狐，被認為是北斗七星的化身也是和平的象徵，太平盛世才會出現的黑狐，在大家喜慶的宴席時陪伴，一起度過和平的一年。採用長野縣產的美山錦，激發出美山錦的魅力，溫柔的口感與美味再進化，充滿果實感與多汁的優雅美味，美山錦的鮮甜美味與廣泛的搭餐性都令人印象深刻。\r\n', '已下架', 65, 'test7.png.png', '2022-01-11 01:22:45', '2022-01-08 21:57:41'),
(66, '篠峯 雄町純米大吟釀', 4, 350, '回購率極高！千代酒造頂級酒款，雄町愛好者不可錯過的一品使用岡山縣赤磐產的雄町，明利酵母與九號酵母雙酵母，研磨至50%取其中段的精華，截取香味最穩定的中取，以生酒的姿態装瓶的纯米大吟釀。開瓶可以感受到甜甜的果香，入口的溫柔酒感帶出迷人的香味，滑入喉嚨後留下甜美溫柔高雅的餘韻，整體輕快又圓潤，由明利酵母與九號酵母釀製而成，混合雄町特有的香氣。清澈輕盈的風味還可以感受到微硬水的微微碳酸感，回購率極高好喝的一品！\r\n', '補貨中', 66, 'test8.png.png', '2022-01-11 01:22:47', '2022-01-11 01:23:04'),
(67, '會津譽 鳳凰標大吟釀', 3, 2, '這瓶大吟釀本身帶有青蘋果、水梨、花香以及成熟核果香氣，入喉後略微辛口清爽，後韻帶有旨味；於2014、2017年IWC競賽中獲得金獎，並由日本國家釀酒研究所頒與金獎14次，2016年亦獲得年度新酒金賞。 乾淨成熟的香氣，良好的深度。入口後可以感受到菠蘿、蘋果以及芒果的味道，後段會帶有圓滑的苦味及旨味餘韻。\r\n', '補貨中', 69, 'test9.png.png', '2022-01-11 01:22:49', '2022-01-11 01:23:07'),
(68, '賀茂鶴 超特撰 特等酒', 2, 3, '榮獲2011年溫酒大賽的「最高位大賞受賞」，酒質圓潤順口，似無角度般的尾韻更是魅力所在。\r\n', '已下架', 70, 'test10.png.png', '2022-01-11 01:22:53', '2022-01-08 22:10:23'),
(69, '大雪溪 阿爾卑斯吟釀 生貯藏酒', 0, 2, '採用長野縣特有阿爾卑斯酵母，奔放的花香系香氣為最大特點之一。口感清爽俐落、層次豐富，是款非常適合搭配海鮮料理的吟釀酒。\r\n', '已下架', 71, 'test11.png.png', '2022-01-11 01:22:56', '2022-01-08 22:12:50'),
(70, '八海山 特別本釀造', 3, 2, '以高度精白的新潟縣產米作為原料，整個製造工程堅持應用傳統製造吟釀的方式製作。為八海釀造的看板商品之一，含在嘴裡散發出來的香氣不輸給吟釀酒，能充分享受到高雅的口感與淡麗的味道。\r\n', '已下架', 72, 'test12.png.png', '2022-01-11 01:22:58', '2022-01-08 22:16:08');
...
(1, 'test001@test001', 'test001', '2022-01-02'),
(2, 'test002@test002', 'test002', '2022-01-02'),
(3, 'test003@test003', 'test003', '2022-01-02'),
(4, 'test004@test004', 'test004', '2022-01-02'),
(5, 'test005@test005', 'test005', '2022-01-02'),
(6, 'test006@test006', 'test006', '2022-01-02'),
(7, 'test007@test007', 'test007', '2022-01-02'),
(8, 'test008@test008', 'test008', '2022-01-02'),
(9, 'test009@test009', 'test009', '2022-01-02'),
(10, 'test010@test010', 'test010', '2022-01-02'),
(11, 'test011@test011', 'test011', '2022-01-02'),
(12, 'test012@test012', 'test012', '2022-01-02'),
(13, 'test013@test013', 'test013', '2022-01-02'),
(14, 'test014@test014', 'test014', '2022-01-02'),
(15, 'test015@test015', 'test015', '2022-01-02'),
(16, 'test016@test016', 'test016', '2022-01-02'),
(17, 'test017@test017', 'test017', '2022-01-02'),
(18, 'test018@test018', 'test018', '2022-01-02'),
(19, 'test019@test019', 'test019', '2022-01-02'),
(20, 'test020@test020', 'test020', '2022-01-02'),
(21, 'test021@test021', 'test021', '2022-01-02'),
(22, 'test022@test022', 'test022', '2022-01-02'),
(23, 'test023@test023', 'test023', '2022-01-02'),
(24, 'test024@test024', 'test024', '2022-01-02'),
(25, 'test025@test025', 'test025', '2022-01-02'),
(26, 'test026@test026', 'test026', '2022-01-02'),
(27, 'test027@test027', 'test027', '2022-01-02');
...
-- 資料表索引 `guide_cate`
--
ALTER TABLE `guide_cate`
  ADD PRIMARY KEY (`guide_c_id`),
  ADD KEY `q_cate` (`q_cate`);
...
ALTER TABLE `guide_q`
  ...
  ADD KEY `q_cate` (`q_cate`) USING BTREE;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `guide_cate`
--
ALTER TABLE `guide_cate`
  MODIFY `guide_c_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `product_format`
  MODIFY `format_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ex:1234', AUTO_INCREMENT=73;
...
--
ALTER TABLE `product_sake`
  MODIFY `pro_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `guide_q`
  ADD CONSTRAINT `guide_q_ibfk_1` FOREIGN KEY (`q_cate`) REFERENCES `guide_cate` (`q_cate`);
